...
contract Ownable {
    //  TODO's
    //  1) create a private 'origOwner' variable of type address with a public getter function
    //  2) create an internal constructor that sets the origOwner var to the creater of the contract 
    ...
    /// An internal function to transfer ownership
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to!=ownerOf(tokenId), "is the same owner of the tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner() || isApprovedForAll(owner() ,msg.sender) == true , "is not owner Or is not isApprovedForAll ");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_exists(tokenId) == false || ( to == address(to) && to != address(0) ),"Token already exists or Invalid address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require( from == ownerOf(tokenId), "The sender address is not the owner of this token");
        // TODO: require token is being transfered to valid address
        require( to == address(to) && to != address(0), "Invalid transfered address");
        // TODO: clear approval
...
contract CustomERC721Token is ERC721Metadata("firstToken","FT","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
